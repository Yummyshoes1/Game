...
public class KyleGame 
{
	...
	//{
		//playerTurn(player damage/enemy resist); gonna finish this once we get stats working
		//enemyTurn(enemy damage/player resist);
	//}
	//public static int playerTurn(//player damage/enemy resist
	//{
		//RNG roll for damage - resist of enemy
	//}
	//public static int enemyTurn(//enemy damage/player resist
		//{
			//RNG roll for damage - resist of player
		//}
